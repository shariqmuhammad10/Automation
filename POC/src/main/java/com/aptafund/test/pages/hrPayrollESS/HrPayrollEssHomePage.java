...
public class HrPayrollEssHomePage extends WaitActions {
    ...
    @FindBy(css = "#menudropdown5>div>ul>li>a")
    private List<WebElementFacade> hrPayrollESSHeader1;

    @FindBy(css = "ul#PayrollPeriodId_listbox li:nth-of-type(8)")
    private WebElementFacade manageDeductionsTitle1;



    @FindBy(id = "menuheader5")
    private WebElementFacade hrPayrollESSHeader;   //div#menuheader5.menuheader

    @FindBy(css = "[href=\"/QAAutom/Payroll/Payroll/Manage\"]")
    private WebElementFacade managePayrollTitle;

    @FindBy(css = "[href=\"/QAAutom/Payroll/PayrollDeduction/Manage\"]")
    private WebElementFacade manageDeductionsTitle;

    @FindBy(css = "[href=\"/QAAutom/Payroll/PayrollEmployeeW2/Manage\"]")
    ...
    @FindBy(css = "[href=\"/QAAutom/Payroll/PayrollEmployeeDeduction/Manage\"]")
    ...
    public void clickHrPayrollESSHeader() {
        ...
        //waitUntilLoaded(hrPayrollESSHeader1);
