...
public class EmployeeJobsPage extends WaitActions {
    ...
    String cycleSalary;
    String SalaryCompareValue = "797.71" ;

    String fullTimePayRate;
    String FTPRCompareValue = "797.71";
    ...
    private WebElementFacade closeJobPopup;
    ...
    @FindBy(css = "[href=\"/QAAutom/HumanResources/Admin/Employee/Employee/EmployeeJobs\"]")
    private WebElementFacade employeeJobsTitle;


    @FindBy(css = "[href=\"/tst01/HumanResources/Admin/Employee/Employee/EmployeeJobs\"]")
    private WebElementFacade employeeJobsTitle1;
    ...
    public void openEmployeeDD() {
        ...
        employeeDD1.click();
        employeeDD1.sendKeys("1Keeling");
       //employeeDD1.sendKeys("Atkinson, Tom Z");
        waitABit(3000);
    ...
    public void clickCloseJobPopup() {
        closeJobPopup.click();
    }
}
