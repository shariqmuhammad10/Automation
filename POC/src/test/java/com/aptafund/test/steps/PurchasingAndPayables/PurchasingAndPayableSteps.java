...
public class PurchasingAndPayableSteps extends ScenarioSteps {
    ...
    @Step
    public void navigateToPurchaseAndPayableForMyPRAdmin(){
        purchasingAndPayablesHomePage.clickPurchaseAndPayableForMyPRAdmin();
    }


    @Step
    public void navigateToMyAptaFund() {
        logger.info("Click on the Purchasing and Payable Header");
        purchasingAndPayablesHomePage.clickOnPurchasingAndPayble();
    }

    @Step
    public void navigateToAdminPR() {
        logger.info("Click on the Purchasing and Payable Header");
        purchasingAndPayablesHomePage.clickOnPurchasingAndPaybleForAdminPR();
    }
